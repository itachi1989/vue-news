    ...
    <div class="top-menu-bar">
      <swiper :options="swiperOption"
        ...
        <swiper-slide v-for="(news, index) in newsList"
                      ...
                      :key="index">{{news.title}}</swiper-slide>
      </swiper>
    </div>
    <a class="top-menu-more-btn df-c"
       href="javascript:void(0)"
       @click="isTopBarBox=true"><i class="list-shadow"></i><span class="cross"></span></a>

    <TopBarBox :class="{'top-bar-active-active': isTopBarBox}"
               @close="isTopBarBox=false"></TopBarBox>
